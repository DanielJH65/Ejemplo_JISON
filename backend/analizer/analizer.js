...
break;
case 5:
 this.$ = new Print.Print($$[$0-2], _$[$0-4].first_line, _$[$0-4].first_colum); 
break;
case 6:
 this.$ = new Native.Native(new Type.Type(Type.dataType.INTEGER), $$[$0], _$[$0].first_line, _$[$0].first_colum); 
break;
case 7:
...
exports.parser = analizer;
exports.Parser = analizer.Parser;
exports.parse = function () { return analizer.parse.apply(analizer, arguments); };
